...
namespace ApiHostData;

public class ApiHostServicesDataContext : DbContext
{
    ...
    public ApiHostServicesDataContext(DbContextOptions<ApiHostServicesDataContext> options) : base(options)
    {
